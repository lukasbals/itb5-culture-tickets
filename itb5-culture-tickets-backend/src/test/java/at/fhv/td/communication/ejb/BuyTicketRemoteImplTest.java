...
public class BuyTicketRemoteImplTest {
    @Mock
    TicketDTO _mockTicketDTOInterface;
    @Mock
    ...
    private BuyTicketRemoteImpl _buyTicket;

    @Before
    public void before() throws RemoteException {
        _buyTicket = new BuyTicketRemoteImpl();
    ...
    public void getTickets() throws RemoteException {
        ...
        TicketDTO[] tickets = _buyTicket.getTickets();
